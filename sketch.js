  ...
  for (var i = 0; i < computerArrows.length; i++) { 
    var base1Collision = Matter.SAT.collides( 
      computerArrows[i].body, playerBase.body
       ...
       var archer1Collision = Matter.SAT.collides( 
      ...
      if(base1Collision.collided || archer1Collision.collided || playerCollision.collided){
        console.log("comp gone case")
      }     
}
}
